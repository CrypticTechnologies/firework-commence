...
<div id="bookingForm">
	...
	<div class="span-12">
		...
		<c:url var="bookingConfirmUrl" value="/bookingConfirm"/>
		<form:form modelAttribute="booking" action="${bookingConfirmUrl}" method="get">
			<fieldset>
			...
			<form:input type="hidden" id="hotel.country" path="hotel.country" name="hotel.country" value="${booking.hotel.country}" />
				...
				<div>
					...
					<div class="span-7 last">
						<p><label for="name">${booking.user.name}</label></p>
					</div>
				</div>
				...
				<div>
					...
					<div class="span-7 last">
						<p><label for="hotelName">${booking.hotel.name}</label></p>
					</div>
				</div>
